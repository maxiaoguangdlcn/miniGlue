...
type
  ...
  protected
    ...
    function GetPanelAreaAtXY(APanel: TigCustomLayer;
      const APanelRect: TRect; const AX, AY: Integer): TigSelectedPanelArea; virtual; abstract;
  public
    constructor Create;

    procedure Paint(ABuffer: TBitmap32; ALayer: TigCustomLayer;
      const ARect: TRect); virtual; abstract;

    function GetSnapshot(ALayer: TigCustomLayer;
...
function TigLayerPanelStdTheme.GetPanelAreaAtXY(APanel: TigCustomLayer;
...
procedure TigLayerPanelStdTheme.Paint(ABuffer: TBitmap32;
  ALayer: TigCustomLayer; const ARect: TRect);
var
  LRect         : TRect;
  LSize         : TSize;
  LBmp          : TBitmap32;
...
function TigLayerPanelStdTheme.GetSnapshot(ALayer: TigCustomLayer;
