...
type
  ...
  public
    ...
    procedure LoadFromFile(const AFileName: TFileName; ALayerList: TigLayerList); virtual;
    procedure LoadFromStream(AStream: TStream; ALayerList: TigLayerList); virtual; abstract;
  end;
  ...
  public
    ...
    procedure LoadFromFile(const AFileName: TFileName; ALayerList: TigLayerList);
    procedure LoadFromStream(AStream: TStream; ALayerList: TigLayerList);
...
procedure TigLayerReader.LoadFromFile(const AFileName: TFileName;
  ALayerList: TigLayerList);
var
  LStream : TStream;
begin
  if FileExists(AFileName) and Assigned(ALayerList) then
  begin
    LStream := TFileStream.Create(AFileName, fmOpenRead	or fmShareDenyNone);
    try
      Self.LoadFromStream(LStream, ALayerList);
    finally
      LStream.Free;
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        LReader.LoadFromStream(AStream, ALayerList);
